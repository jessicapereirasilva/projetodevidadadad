...
const perguntas = [
    {
        enunciado: "Amizades verdadeira são aquelas que duram para sempre?",
        alternativas: [
            {
                texto: "Verdadeiro!",
    ...
    {
        enunciado: "Qual da seguintes não é uma características importante de uma boa amizade?",
        alternativas: [
            {
                texto: "Confiança .",
...
function mostraResultado() {
    caixaPerguntas.textContent = " sobre a amizade.";
